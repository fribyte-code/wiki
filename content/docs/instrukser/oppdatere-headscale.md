...
[extra]
lang = "no"
translation = "docs/instrukser/oppdatere-headscale-en.md"
+++
...
4. Kjør [installasjonsprosessen](https://headscale.net/stable/setup/install/official/#using-packages-for-debianubuntu-recommended) på nytt ved å sette `HEADSCALE_VERSION` til det nye versjonsnummeret og `HEADSCALE_ARCH="amd64"`
